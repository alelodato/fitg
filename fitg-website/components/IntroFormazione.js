...
const paragrafi = [
    'I Tactical Games sono competizioni sportive multidisciplinari. Una definizione che, già da sola, rivela la complessità di questa disciplina: non si tratta di eccellere in una singola capacità, ma di integrare tre domini esigenti — la resistenza fisica, la precisione tecnica e la lucidità mentale sotto pressione — in un\'unica prestazione coerente e controllata.',
    ...
    'La preparazione nei Tactical Games richiede dunque un approccio integrato, che lavori in parallelo su forza funzionale, resistenza cardiovascolare, mobilità articolare e coordinazione motoria — il tutto calibrato sulle specificità del gesto tecnico legato all\'uso dell\'arma. Non basta essere atleti completi in senso generale: occorre diventare atleti completi in quel contesto, capaci di mantenere precisione, controllo e sicurezza anche quando il corpo è sotto sforzo massimale.',
]
        ...
        <section className="bg-[#1A1A1A]">
            ...
            <div className="px-5 md:px-16 py-14 md:py-24">
                ...
                <FadeIn className="mb-12 md:mb-16">
                    <p className="font-inter text-[17px] md:text-[22px] text-[#eee] leading-[1.7] max-w-3xl border-l-2 border-gold pl-5 md:pl-7">
                        {paragrafi[1]}
                    </p>
                </FadeIn>
