...
const consigli = [
    { titolo: 'Fitness Funzionale', desc: 'Descrizione — fornita dal cliente.' },
    { titolo: 'Tiro di Precisione', desc: 'Descrizione — fornita dal cliente.' },
    { titolo: 'Preparazione Mentale', desc: 'Descrizione — fornita dal cliente.' },
    { titolo: 'Recupero e Nutrizione', desc: 'Descrizione — fornita dal cliente.' },
]

const aree = [
    { nome: 'Area 1', luogo: 'Città, Regione', desc: 'Descrizione area — fornita dal cliente.' },
    { nome: 'Area 2', luogo: 'Città, Regione', desc: 'Descrizione area — fornita dal cliente.' },
    { nome: 'Area 3', luogo: 'Città, Regione', desc: 'Descrizione area — fornita dal cliente.' },
]
            ...
            <section className="bg-[#1A1A1A] px-5 md:px-16 py-12 md:py-16 border-b border-gold/20">
                <div className="max-w-3xl">
                    <p className="font-inter text-[14px] md:text-[15px] text-[#ccc] leading-relaxed">
                        Testo introduttivo alla formazione — fornito dal cliente.
                    </p>
                    <p className="font-inter text-[14px] md:text-[15px] text-[#ccc] leading-relaxed mt-4">
                        Secondo paragrafo — fornito dal cliente.
                    </p>
                </div>
            </section>
